...
export default defineConfig({
  ...
  testIgnore: "visual-preview.spec.ts",
  outputDir: join(tmpdir(), `v17-crm-icp-ui-${process.pid}`),
  timeout: 60_000,
  ...
  forbidOnly: true,
  reporter: "list",
  use: { baseURL: "http://127.0.0.1:4192", trace: "off", screenshot: "off", video: "off", serviceWorkers: "block" },
  webServer: {
    ...
    env: {
      ...
      VITE_CRM_ICP_V2_UI_MODE: "LOCAL_ONLY",
    },
  },
  projects: [
