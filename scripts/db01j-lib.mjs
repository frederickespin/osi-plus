...
export function assertDb01jLocalUrl(value = process.env.DB01J_DATABASE_URL) {
  ...
  if (!["127.0.0.1", "localhost"].includes(url.hostname) || Number(url.port) !== 55432 || !(database.startsWith("osi_db01j_") || database.startsWith("osi_db01n_") || database === "osi_mt01c1b3a_q1_20260809")) {
