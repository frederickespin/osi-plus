...
async function main() {
  ...
  console.log(JSON.stringify({ ok: true, batch: EXPECTED_BATCH, migrations: "32/32", scenarios: 4, securitySentinels: 1, syntheticOnly: true, idempotent: true, counts, scenarioCBlocker: true, scenarioDAccepted: scenarioDQuotes.accepted.state === "ACCEPTED", schedulingPolicy: "ACTIVE", productionApiEnabled: false }));
}
