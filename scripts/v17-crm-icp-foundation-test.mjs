...
reject("el servidor rechaza un modo que contradice origen y destino", "CRM_ICP_ROUTE_INVALID", () => buildCrmIcpV2AtomicPlan(
  command(unsigned({ mode: "EXPORT" })), authority(),
));
