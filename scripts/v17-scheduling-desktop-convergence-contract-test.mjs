...
fails("estado de visita incompatible con método remoto", () => normalizeSchedulingMutation(signed("DECIDE_METHOD", { caseRef: uuid(4), expectedVersion: null, method: "VIRTUAL", commercialState: "READY_TO_SCHEDULE", informationSource: "CLIENT", rationaleCode: null })), "CRM_SURVEY_METHOD_STATE_INVALID");
