...
export function assertCanonicalCiTarget(raw = process.env.DATABASE_URL) {
  ...
  invariant(new Set(["osi_db01n_ci", "osi_mt01c1b3a_q1_20260809", "osi_mt01c2b1_local", "osi_db01n_mt01c2b1_local", "osi_mt01c2b2_local", "osi_db01n_mt01c2b2_local"]).has(database), "La base canónica debe pertenecer a la allowlist local exacta");
...
async function validateDatabase(raw) {
  ...
  try {
    ...
    invariant(new Set(["osi_db01n_ci", "osi_mt01c1b3a_q1_20260809", "osi_mt01c2b1_local", "osi_db01n_mt01c2b1_local", "osi_mt01c2b2_local", "osi_db01n_mt01c2b2_local"]).has(identity[0]?.database) && identity[0]?.schema === "osi", "Identidad PostgreSQL inesperada");
