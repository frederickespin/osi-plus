...
rejected("grupo capturante inválido de Vercel rechazado", { overrides: { "vercel.json": vercel.replace("(?:transition|assign-owner|unassign-owner|allowed-transitions)", "(transition|assign-owner|unassign-owner|allowed-transitions)") } }, /no capturante/);
