...
rejected("CORS global de Vercel sobre CRM rechazado", { overrides: { "vercel.json": vercel.replace("(?!auth/|admin/|crm/|clients(?:/|$)|projects(?:/|$)|k/project-(?:validate|release)(?:/|$))", "(?!auth/|admin/|clients(?:/|$)|projects(?:/|$)|k/project-(?:validate|release)(?:/|$))") } }, /Vercel/);
