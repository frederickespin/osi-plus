...
export function validateCrm01b3b3Guard({ root = process.cwd(), overrides = {}, extraSources = {}, migrationNames } = {}) {
  ...
  invariant(migrations.length === 18 && migrations.includes("20260801020000_v17_pipeline_case_client_authority") && migrations.includes("20260821010000_v17_pipeline_case_public_ref"), "se exigen 18 migraciones canónicas exactas");
  ...
  return Object.freeze({ ok: true, migrations: 18, routes: routes.length, ttlSeconds: 300 });
}
