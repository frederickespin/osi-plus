...
check("autenticación JWT heredada no puede eliminarse", () => validateMt01b3aSources({ routeSources: new Map([...routeSources].map(([key, value]) => [key, key === "api/users/index.js" ? value.replaceAll("requireAuth", "legacyAuthRemoved") : value])), envExample, authContextSource }), true);
