...
try {
  ...
  check("MT-01C1A remains migration thirteen in the eighteen-migration chain", current.length === 19 && CANONICAL_MIGRATIONS[12] === "20260801012000_mt01c1a_employee_profiles");
  ...
  check("unexpected migration twenty is rejected", rejected?.message.includes("19 migraciones canónicas"));
