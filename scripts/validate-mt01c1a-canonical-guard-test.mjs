...
try {
  ...
  check("MT-01C1A remains migration thirteen in the canonical chain", current.length === 24 && CANONICAL_MIGRATIONS[12] === "20260801012000_mt01c1a_employee_profiles");
  ...
  check("unexpected migration twenty-five is rejected", rejected?.message.includes("24 migraciones canónicas"));
