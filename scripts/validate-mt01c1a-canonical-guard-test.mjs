...
try {
  ...
  check("MT-01C1A remains migration thirteen in the seventeen-migration chain", current.length === 17 && CANONICAL_MIGRATIONS[12] === "20260801012000_mt01c1a_employee_profiles");
