...
try {
  base();
  const migrations = Array.from({ length: 18 }, (_, index) => `prisma/migrations/${String(index).padStart(2, "0")}/migration.sql`);
  ...
  base();
  expectFailure("migración número 19 rechazada", [...safeFiles, "prisma/migrations/19/migration.sql"], {}, /exactamente 18 migraciones/);
  base();
