...
try {
  base();
  const migrations = Array.from({ length: 17 }, (_, index) => `prisma/migrations/${String(index).padStart(2, "0")}/migration.sql`);
  ...
  base();
  expectFailure("migración número 18 rechazada", [...safeFiles, "prisma/migrations/17/migration.sql"], {}, /exactamente 17 migraciones/);
  base();
