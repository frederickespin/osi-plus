...
export function validateMt01c1b2bGuard({ root = process.cwd(), files = trackedFiles(), env = process.env } = {}) {
  ...
  invariant(migrations.length === 22 && migrations.includes("prisma/migrations/20260831010000_v17_crm_icp_foundation/migration.sql"), `la cadena canónica debe conservar exactamente 22 migraciones; encontradas=${migrations.length}`);
