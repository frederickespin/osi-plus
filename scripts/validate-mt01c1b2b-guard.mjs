...
export function validateMt01c1b2bGuard({ root = process.cwd(), files = trackedFiles(), env = process.env } = {}) {
  ...
  invariant((migrations.length === 22 || (migrations.length === 23 && migrations.includes("prisma/migrations/20260904010000_v17_services_tenant_first/migration.sql")) || (migrations.length === 24 && migrations.includes("prisma/migrations/20260904010000_v17_services_tenant_first/migration.sql") && migrations.includes("prisma/migrations/20260905010000_v17_survey_foundation/migration.sql"))) && migrations.includes("prisma/migrations/20260831010000_v17_crm_icp_foundation/migration.sql"), `la cadena canónica o extensión Servicios/Survey es inválida; encontradas=${migrations.length}`);
