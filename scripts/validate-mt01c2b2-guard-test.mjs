...
reject("migración 20 rechazada", (root) => cpSync(join(root, "prisma", "migrations", "20260801015000_crm01b_pipeline_mutation_authority"), join(root, "prisma", "migrations", "20260825010000_forbidden"), { recursive: true }), "exactamente 19 migraciones");
