...
reject("migración 19 rechazada", (root) => cpSync(join(root, "prisma", "migrations", "20260801015000_crm01b_pipeline_mutation_authority"), join(root, "prisma", "migrations", "20260821020000_forbidden"), { recursive: true }), "exactamente 18 migraciones");
