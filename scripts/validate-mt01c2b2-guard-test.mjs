...
reject("migración 18 rechazada", (root) => cpSync(join(root, "prisma", "migrations", "20260801015000_crm01b_pipeline_mutation_authority"), join(root, "prisma", "migrations", "20260801021000_forbidden"), { recursive: true }), "exactamente 17 migraciones");
