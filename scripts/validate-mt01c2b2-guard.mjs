...
export function validateMt01c2b2Guard(root = process.cwd()) {
  ...
  invariant(migrations.length === 18, "deben existir exactamente 18 migraciones");
  ...
  return { ok: true, migrations: 18, runtimeConsumers: 0, automaticHooks: 0, c2b3Blocked: true, expected: { ...{ clients: 7, projects: 2, leads: 0, pipelineCases: 51, mappedOwners: 39, unassigned: 12 } }, modes: { legacy: true, hybrid: false, tenantSwitch: false, clientV2: false } };
}
