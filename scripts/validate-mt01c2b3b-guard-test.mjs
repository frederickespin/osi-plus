...
try {
  ...
  check("estado actual aprobado", baseline.ok && baseline.migrations === 22 && baseline.preparedRoutes.length === 6 && baseline.activationBlockers.length === 4);
  ...
  rejected("migración 23 rechazada", { migrationNames: [...Array.from({ length: 22 }, (_, i) => `m${i}`), "20260901010000_unexpected"] }, /22 migraciones/);
