...
try {
  ...
  check("estado actual aprobado", baseline.ok && baseline.migrations === 21 && baseline.preparedRoutes.length === 6 && baseline.activationBlockers.length === 4);
  ...
  rejected("migración 22 rechazada", { migrationNames: [...Array.from({ length: 21 }, (_, i) => `m${i}`), "20260828010000_unexpected"] }, /21 migraciones/);
