...
try {
  ...
  check("estado inactivo actual aprobado", baseline.ok && baseline.migrations === 17 && baseline.previewBlocked);
  ...
  rejected("migración 18 rechazada", {
    migrationNames: [...Array.from({ length: 17 }, (_, index) => `m${index}`), "20260801021000_unexpected"],
  }, /17 migraciones/);
