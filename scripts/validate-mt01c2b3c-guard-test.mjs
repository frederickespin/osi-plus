...
try {
  ...
  check("estado inactivo actual aprobado", baseline.ok && baseline.migrations === 18 && baseline.previewBlocked);
  ...
  rejected("migración 19 rechazada", {
    migrationNames: [...Array.from({ length: 18 }, (_, index) => `m${index}`), "20260821020000_unexpected"],
  }, /18 migraciones/);
