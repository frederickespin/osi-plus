...
export function validateV17CaseClientGuard({
  ...
  invariant(migrations.length >= MINIMUM_MIGRATIONS, `se exigen al menos ${MINIMUM_MIGRATIONS} migraciones`);
  ...
  invariant(migrations.includes(V17_ADMIN_IDENTITY_INVITATION_MIGRATION), "la migración 21 autorizada debe existir");
  invariant(migrations.indexOf(V17_CRM_ICP_FOUNDATION_MIGRATION) === 21, "la migración 22 ICP debe conservar su posición canónica");
