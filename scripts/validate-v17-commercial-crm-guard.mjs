...
invariant(migrations.length === 20, `se esperaban 20 migraciones, existen ${migrations.length}`);
...
console.log(JSON.stringify({ ok: true, migrations: 20, routes: 3, methods: ["GET", "HEAD", "OPTIONS"], authorizationBoundary: "PRE_LAZY" }));
