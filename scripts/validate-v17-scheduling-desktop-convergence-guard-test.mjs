...
const cases = [
  ...
  ["permisos explícitos", "api/_lib/rbac.js", (value) => value.replace(/  PERMS\.SURVEY_SCHEDULE_ASSIGN,\r?\n/u, "")],
  ...
  ["CORS", "scripts/protected-cors-route-inventory.json", (value) => value.replace(/      "\/api\/crm\/survey\/scheduling",\r?\n/u, "")],
