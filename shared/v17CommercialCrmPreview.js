...
function absentOrExact(value, expected) {
...
export function isExactV17CommercialCrmPreviewServerEnvironment(environment = {}) {
  return environment.VERCEL_ENV === "preview"
    ...
    && environment.CRM_PIPELINE_ACTIVATION_BATCH === V17_COMMERCIAL_CRM_PREVIEW_BATCH
    && absentOrExact(environment.MT01B_AUTH_MODE, LEGACY)
    && absentOrExact(environment.MT01B_TENANT_SWITCH_ENABLED, "false")
    && absentOrExact(environment.VITE_MT01B2_CLIENT_ENABLED, "false")
