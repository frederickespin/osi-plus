...
import { AlertCircle, ArrowLeft, BellRing, CheckCircle2, ChevronLeft, ChevronRight, Filter, MapPin, Plus, Search } from "lucide-react";
...
import { CrmIcpV2Api, type IcpCreateReceipt } from "@/crm-icp-v2/api";
...
export default function CommercialInboxModule({ authorization, mutationAccess, servicesAccess, role, caseRef, onOpenNavigation, onBack, onOpenCase, onReturnToInbox, onUnauthorized, api: suppliedApi }: Props) {
  ...
  const [icpReceipt, setIcpReceipt] = useState<IcpCreateReceipt | null>(null);
