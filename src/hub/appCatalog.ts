...
export const HUB_APPLICATIONS: readonly HubApplication[] = Object.freeze([
  ...
  { appId: "administration", name: "Administración", description: "Acceso, membresías, plantillas y reglas transversales del tenant.", icon: "settings", route: "/administration", status: "REGISTERED_INACTIVE", requiredPermissions: ["membership:view", "logistics:rules:view", "communications:templates:view"], permissionMode: "ANY", requiresExplicitPermissions: true, baselineRoles: [], mobileAvailability: "RESPONSIVE", directAccessAllowed: true, lazy: true },
