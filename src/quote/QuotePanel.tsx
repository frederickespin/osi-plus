...
type Props = Readonly<{ caseRef: string; authorization?: string; access: QuoteUiAccess; communicationsEnabled?: boolean; communicationsAccess?: CommunicationsAccess; onOpenCommunications?(): void; onUnauthorized(): void }>;
...
export default function QuotePanel({ caseRef, authorization, access, communicationsEnabled = false, communicationsAccess, onOpenCommunications, onUnauthorized }: Props) {
