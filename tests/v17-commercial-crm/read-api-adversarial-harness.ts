...
const detail = { caseRef, caseCode: "CASE-1", status: "NEW_INBOX", mode: "LOCAL", serviceType: "Servicio", client: null, owner: null, createdAt: "2026-08-18T10:00:00.000Z", updatedAt: "2026-08-18T10:00:00.000Z" };
...
const scenarios: Scenario[] = [
  ...
  { name: "list-client-field", response: () => json({ ...validList, data: [{ ...row, client: { displayName: "Client", type: "PERSON", status: "active", email: "forbidden@example.invalid" } }] }) },
