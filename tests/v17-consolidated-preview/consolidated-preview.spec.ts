...
const commercialContext = { commercialContextRef: "638f6d8f-8d11-4f39-8a2d-1b6c7e8f9012", seriesRef: "648f6d8f-8d11-4f39-8a2d-1b6c7e8f9012", version: 2, commercialRelationshipRef: null, payerRef: "658f6d8f-8d11-4f39-8a2d-1b6c7e8f9012", pricingAgreementRef: "668f6d8f-8d11-4f39-8a2d-1b6c7e8f9012", referralAgreementRef: "678f6d8f-8d11-4f39-8a2d-1b6c7e8f9012", agreement: { pricingAgreementRef: "668f6d8f-8d11-4f39-8a2d-1b6c7e8f9012", version: 1, validFrom: "2026-01-01T00:00:00.000Z", validTo: null, tariff: { tariffRef: "688f6d8f-8d11-4f39-8a2d-1b6c7e8f9012", code: "CORP-USD", name: "Tarifario corporativo", version: 1, currency: "USD" }, adjustments: [{ adjustmentRef: "698f6d8f-8d11-4f39-8a2d-1b6c7e8f9012", kind: "DISCOUNT", calculationType: "PERCENTAGE", value: 8, base: "SERVICE_TOTAL", reasonCode: "CORPORATE", authorized: true, validFrom: null, validTo: null }] }, referral: { referralAgreementRef: "678f6d8f-8d11-4f39-8a2d-1b6c7e8f9012", version: 1, calculationType: "PERCENTAGE", value: 3, currency: "USD", reference: "Referido Preview", validFrom: null, validTo: null }, parties: [{ role: "COMPANY", entityRef: "718f6d8f-8d11-4f39-8a2d-1b6c7e8f9012", relationshipRef: null, displayName: "Empresa Preview", kind: "COMPANY", validFrom: null, validTo: null, contacts: [] }, { role: "LEAD_ACCOUNT", entityRef: "728f6d8f-8d11-4f39-8a2d-1b6c7e8f9012", relationshipRef: null, displayName: "Lead Account Preview", kind: "LEAD_ACCOUNT", validFrom: "2026-01-01T00:00:00.000Z", validTo: null, contacts: [{ contactRef: "738f6d8f-8d11-4f39-8a2d-1b6c7e8f9012", displayName: "Contacto Lead Preview", position: "Coordinación", preferredChannel: "EMAIL" }] }, { role: "BOOKER", entityRef: "748f6d8f-8d11-4f39-8a2d-1b6c7e8f9012", relationshipRef: null, displayName: "Booker Preview", kind: "PERSON", validFrom: null, validTo: null, contacts: [{ contactRef: "758f6d8f-8d11-4f39-8a2d-1b6c7e8f9012", displayName: "Booker Preview", position: "Booker", preferredChannel: "PHONE" }] }, { role: "PAYER", entityRef: "658f6d8f-8d11-4f39-8a2d-1b6c7e8f9012", relationshipRef: null, displayName: "Pagador Preview", kind: "COMPANY", validFrom: null, validTo: null, contacts: [] }, { role: "APPROVER", entityRef: "768f6d8f-8d11-4f39-8a2d-1b6c7e8f9012", relationshipRef: null, displayName: "Aprobador actual distinto", kind: "PERSON", validFrom: null, validTo: null, contacts: [] }], associations: [{ membershipRef: "778f6d8f-8d11-4f39-8a2d-1b6c7e8f9012", associationName: "Asociación Preview", membershipNumber: "SYNTH-001", validFrom: null, validTo: null }], instructions: [{ instructionRef: "788f6d8f-8d11-4f39-8a2d-1b6c7e8f9012", category: "COMMERCIAL", priority: 10, content: { text: "Copiar al Booker en comunicaciones." } }], logicalSha256: "d".repeat(64) };
const proposals = [1, 2, 3].map((position) => ({ proposalRef: `${position}58f6d8f-8d11-4f39-8a2d-1b6c7e8f9012`, reference: `Q-2026-00000${position}`, position, state: position === 2 ? "ACCEPTED" : "SENT", revisionRef: `${position}68f6d8f-8d11-4f39-8a2d-1b6c7e8f9012`, revision: 2, proposalName: `Propuesta ${position}`, costingRevisionRef: COSTING_REF, currency: "USD", issueDate: "2026-09-05", validUntil: "2026-10-05", totals: { totalQuotedPrice: 800 + position * 50 }, lines: [], issues: [], logicalSha256: "c".repeat(64), commercialContext: { company: null, leadAccount: { displayName: "Lead Account histórico", reference: "opaque", kind: "LEAD_ACCOUNT", version: 1, validFrom: null, validUntil: null, conditions: null }, booker: { displayName: "Booker histórico", reference: "opaque", kind: "BOOKER", version: 1, validFrom: null, validUntil: null, conditions: null }, tariff: { displayName: "Tarifario histórico", reference: "opaque", kind: "PRICING_AGREEMENT", version: 1, validFrom: null, validUntil: null, conditions: null }, associations: ["Asociación histórica"], referral: { displayName: "Referido histórico", reference: "opaque", kind: "REFERRAL_AGREEMENT", version: 1, validFrom: null, validUntil: null, conditions: null }, commissionContext: null }, payer: { displayName: "Pagador histórico", reference: "opaque", kind: "COMPANY", sourceVersion: 1, validFrom: null, validUntil: null, conditions: null } }));
...
async function mockDomains(page: Page) {
  ...
  await page.route("**/api/commercial-relationships/entities?*", (route) => route.fulfill({ status: 200, contentType: "application/json", headers: privateHeaders, body: JSON.stringify({ ok: true, data: { page: 1, pageSize: 20, total: commercialContext.parties.length, items: commercialContext.parties.map((party, index) => ({ entityRef: party.entityRef, code: `ENTITY-${index + 1}`, displayName: party.displayName, legalName: null, kind: party.kind, countryCode: "DO", status: "ACTIVE", validFrom: party.validFrom, validTo: party.validTo, version: 1, client: null, contacts: party.contacts })) } }) }));
  await page.route("**/api/commercial-relationships/relationships", (route) => route.fulfill({ status: 200, contentType: "application/json", headers: privateHeaders, body: JSON.stringify({ ok: true, data: [] }) }));
...
test("deny detiene el flujo antes de chunks y APIs protegidas", async ({ page }) => {
  ...
  const chunks = await page.evaluate(() => performance.getEntriesByType("resource").map((entry) => entry.name).filter((name) => /AdvancedErpShell|CommercialCaseDetail|SurveyCasePanel|QuotePanel|CommercialRelationshipsAdmin|CaseCommercialContextPanel/.test(name)));
  expect(chunks).toHaveLength(0);
});

test("administra catálogos comerciales compactos sin afectar el flujo del caso", async ({ page }) => {
  await authorize(page); await mockDomains(page); await page.goto("/commercial/relationships");
  await expect(page.getByRole("heading", { name: "Relaciones Comerciales" })).toBeVisible();
  for (const tab of ["Tarifarios", "Referidos", "Comisiones", "Asociaciones", "Certificaciones"]) {
    await page.getByRole("tab", { name: tab }).click();
  }
  await expect(page.getByText("CERTIFICACIÓN PREVIEW")).toBeVisible();
  expect(await page.evaluate(() => document.documentElement.scrollWidth - document.documentElement.clientWidth)).toBeLessThanOrEqual(1);
});
